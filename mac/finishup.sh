...
then
    ...
    cp -f mac/exit.png "$APPNAME.app/Contents/Resources/251.png"
    ...
    cp -f mac/help.png "$APPNAME.app/Contents/Resources/253.png"
    cp -f mac/about.png "$APPNAME.app/Contents/Resources/254.png"
    cp -f mac/preferences.png "$APPNAME.app/Contents/Resources/255.png"
	...
	cp -f libminimal.so "$APPNAME.app/Contents/MacOS/libminimal.dylib"
fi
